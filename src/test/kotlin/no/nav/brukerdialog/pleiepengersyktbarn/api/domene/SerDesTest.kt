...
import no.nav.brukerdialog.pleiepengersyktbarn.utils.SøknadUtils
...
import no.nav.brukerdialog.pleiepengersyktbarn.api.domene.KomplettPleiepengerSyktBarnSøknad
...
import no.nav.brukerdialog.pleiepengersyktbarn.api.domene.UtenlandskNæring
            ...
            utenlandsoppholdIPerioden = no.nav.brukerdialog.pleiepengersyktbarn.api.domene.UtenlandsoppholdIPerioden(
                skalOppholdeSegIUtlandetIPerioden = true, opphold = listOf(
                    no.nav.brukerdialog.pleiepengersyktbarn.api.domene.Utenlandsopphold(
                        ...
                        erUtenforEøs = false,
                        erSammenMedBarnet = false,
                        årsak = no.nav.brukerdialog.pleiepengersyktbarn.api.domene.Årsak.ANNET
                    ),
                    no.nav.brukerdialog.pleiepengersyktbarn.api.domene.Utenlandsopphold(
                        fraOgMed = LocalDate.parse("2019-10-10"),
                        tilOgMed = LocalDate.parse("2019-11-10"),
