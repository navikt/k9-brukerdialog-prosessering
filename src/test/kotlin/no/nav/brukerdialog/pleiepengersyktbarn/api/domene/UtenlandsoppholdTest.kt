...
import no.nav.brukerdialog.pleiepengersyktbarn.api.domene.Utenlandsopphold
...
class UtenlandsoppholdTest {
    ...
    fun `toString har med seg det den skal`() {
        ...
        val utenlandsopphold = no.nav.brukerdialog.pleiepengersyktbarn.api.domene.Utenlandsopphold(
