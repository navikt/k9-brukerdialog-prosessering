package no.nav.brukerdialog.pleiepengersyktbarn.utils
...
import no.nav.brukerdialog.pleiepengersyktbarn.api.domene.Arbeidsgiver
import no.nav.brukerdialog.pleiepengersyktbarn.api.domene.BarnDetaljer
import no.nav.brukerdialog.pleiepengersyktbarn.api.domene.BarnRelasjon
import no.nav.brukerdialog.pleiepengersyktbarn.api.domene.Beredskap
import no.nav.brukerdialog.pleiepengersyktbarn.api.domene.Bosted
import no.nav.brukerdialog.pleiepengersyktbarn.api.domene.Enkeltdag
import no.nav.brukerdialog.pleiepengersyktbarn.api.domene.Ferieuttak
import no.nav.brukerdialog.pleiepengersyktbarn.api.domene.FerieuttakIPerioden
...
import no.nav.brukerdialog.pleiepengersyktbarn.api.domene.Medlemskap
import no.nav.brukerdialog.pleiepengersyktbarn.api.domene.Nattevåk
import no.nav.brukerdialog.pleiepengersyktbarn.api.domene.Omsorgstilbud
import no.nav.brukerdialog.pleiepengersyktbarn.api.domene.OmsorgstilbudSvarFortid
import no.nav.brukerdialog.pleiepengersyktbarn.api.domene.OpptjeningIUtlandet
import no.nav.brukerdialog.pleiepengersyktbarn.api.domene.OpptjeningType
...
import no.nav.brukerdialog.pleiepengersyktbarn.api.domene.SelvstendigNæringsdrivende
import no.nav.brukerdialog.pleiepengersyktbarn.api.domene.Språk
import no.nav.brukerdialog.pleiepengersyktbarn.api.domene.StønadGodtgjørelse
import no.nav.brukerdialog.pleiepengersyktbarn.api.domene.arbeid.ArbeidIPeriodeType
import no.nav.brukerdialog.pleiepengersyktbarn.api.domene.arbeid.Arbeidsforhold
...
class SøknadUtils {
    companion object {
        ...
        fun defaultSøknad(søknadId: String = UUID.randomUUID().toString()) = PleiepengerSyktBarnSøknad(
            ...
            arbeidsgivere = listOf(
                Arbeidsgiver(
                    ...
                    arbeidsforhold = Arbeidsforhold(
                        ...
                        arbeidIPeriode = no.nav.brukerdialog.pleiepengersyktbarn.api.domene.arbeid.ArbeidIPeriode(
            ...
            utenlandsoppholdIPerioden = no.nav.brukerdialog.pleiepengersyktbarn.api.domene.UtenlandsoppholdIPerioden(
                skalOppholdeSegIUtlandetIPerioden = true, opphold = listOf(
                    no.nav.brukerdialog.pleiepengersyktbarn.api.domene.Utenlandsopphold(
                        ...
                        årsak = no.nav.brukerdialog.pleiepengersyktbarn.api.domene.Årsak.BARNET_INNLAGT_I_HELSEINSTITUSJON_DEKKET_ETTER_AVTALE_MED_ET_ANNET_LAND_OM_TRYGD
                    ),
                    no.nav.brukerdialog.pleiepengersyktbarn.api.domene.Utenlandsopphold(
                        ...
                        erUtenforEøs = false,
                        erSammenMedBarnet = false,
                        årsak = no.nav.brukerdialog.pleiepengersyktbarn.api.domene.Årsak.BARNET_INNLAGT_I_HELSEINSTITUSJON_FOR_NORSK_OFFENTLIG_REGNING
                    ),
                    no.nav.brukerdialog.pleiepengersyktbarn.api.domene.Utenlandsopphold(
