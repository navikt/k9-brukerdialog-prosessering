package no.nav.brukerdialog.meldinger.omsorgspengerutbetalingsnf.utils
...
import no.nav.brukerdialog.meldinger.omsorgpengerutbetalingsnf.domene.FraværÅrsak
import no.nav.brukerdialog.meldinger.omsorgpengerutbetalingsnf.domene.Frilans
import no.nav.brukerdialog.meldinger.omsorgpengerutbetalingsnf.domene.JaNei
import no.nav.brukerdialog.meldinger.omsorgpengerutbetalingsnf.domene.Næringstyper
...
import no.nav.brukerdialog.meldinger.omsorgpengerutbetalingsnf.domene.TypeBarn
...
internal object OMPUtbetalingSNFSøknadUtils {
    ...
    internal fun defaultSøknad(søknadId: String, mottatt: ZonedDateTime) = OMPUtbetalingSNFSoknadMottatt(
        ...
        barn = listOf(
            no.nav.brukerdialog.meldinger.omsorgpengerutbetalingsnf.domene.Barn(
