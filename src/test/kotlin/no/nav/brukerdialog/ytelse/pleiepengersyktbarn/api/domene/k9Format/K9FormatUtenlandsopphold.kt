...
class K9FormatUtenlandsopphold {
    ...
    fun `UtenlandsoppholdIPerioden med en innleggelse mappes riktig`() {
        val utenlandsopphold = no.nav.brukerdialog.ytelse.pleiepengersyktbarn.api.domene.UtenlandsoppholdIPerioden(
            skalOppholdeSegIUtlandetIPerioden = true,
            opphold = listOf(
                no.nav.brukerdialog.ytelse.pleiepengersyktbarn.api.domene.Utenlandsopphold(
                    ...
                    årsak = no.nav.brukerdialog.ytelse.pleiepengersyktbarn.api.domene.Årsak.BARNET_INNLAGT_I_HELSEINSTITUSJON_DEKKET_ETTER_AVTALE_MED_ET_ANNET_LAND_OM_TRYGD
                )
            )
        )
