package no.nav.brukerdialog.ytelse.pleiepengersyktbarn.api
...
import no.nav.brukerdialog.ytelse.pleiepengersyktbarn.api.domene.Nattevåk.Companion.MAX_FRITEKST_TEGN
import no.nav.brukerdialog.ytelse.pleiepengersyktbarn.api.domene.NormalArbeidsdag
...
import no.nav.brukerdialog.ytelse.pleiepengersyktbarn.api.domene.arbeid.ArbeidsRedusert
...
import no.nav.brukerdialog.ytelse.pleiepengersyktbarn.api.domene.arbeid.RedusertArbeidstidType
...
@WebMvcTest(
    controllers = [no.nav.brukerdialog.ytelse.pleiepengersyktbarn.api.PleiepengerSyktBarnController::class]
)
@Import(
