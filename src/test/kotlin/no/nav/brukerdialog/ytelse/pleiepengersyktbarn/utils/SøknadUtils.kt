...
import no.nav.brukerdialog.ytelse.pleiepengersyktbarn.api.domene.BarnRelasjon
import no.nav.brukerdialog.ytelse.pleiepengersyktbarn.api.domene.Beredskap
import no.nav.brukerdialog.ytelse.pleiepengersyktbarn.api.domene.Bosted
import no.nav.brukerdialog.ytelse.pleiepengersyktbarn.api.domene.Enkeltdag
import no.nav.brukerdialog.ytelse.pleiepengersyktbarn.api.domene.Ferieuttak
import no.nav.brukerdialog.ytelse.pleiepengersyktbarn.api.domene.FerieuttakIPerioden
import no.nav.brukerdialog.ytelse.pleiepengersyktbarn.api.domene.Frilans
import no.nav.brukerdialog.ytelse.pleiepengersyktbarn.api.domene.FrilansType
import no.nav.brukerdialog.ytelse.pleiepengersyktbarn.api.domene.Medlemskap
import no.nav.brukerdialog.ytelse.pleiepengersyktbarn.api.domene.Nattevåk
import no.nav.brukerdialog.ytelse.pleiepengersyktbarn.api.domene.Omsorgstilbud
import no.nav.brukerdialog.ytelse.pleiepengersyktbarn.api.domene.OmsorgstilbudSvarFortid
import no.nav.brukerdialog.ytelse.pleiepengersyktbarn.api.domene.OpptjeningIUtlandet
import no.nav.brukerdialog.ytelse.pleiepengersyktbarn.api.domene.OpptjeningType
...
import no.nav.brukerdialog.ytelse.pleiepengersyktbarn.api.domene.StønadGodtgjørelse
import no.nav.brukerdialog.ytelse.pleiepengersyktbarn.api.domene.Utenlandsopphold
import no.nav.brukerdialog.ytelse.pleiepengersyktbarn.api.domene.UtenlandsoppholdIPerioden
import no.nav.brukerdialog.ytelse.pleiepengersyktbarn.api.domene.arbeid.ArbeidIPeriode
import no.nav.brukerdialog.ytelse.pleiepengersyktbarn.api.domene.arbeid.ArbeidIPeriodeType
import no.nav.brukerdialog.ytelse.pleiepengersyktbarn.api.domene.arbeid.Arbeidsforhold
import no.nav.brukerdialog.ytelse.pleiepengersyktbarn.api.domene.arbeid.NormalArbeidstid
import no.nav.brukerdialog.ytelse.pleiepengersyktbarn.api.domene.Årsak
