...
class UtenlandsoppholdTest {
    ...
    fun `toString har med seg det den skal`() {
        ...
        assertEquals(
            forventet,
            "Utenlandsopphold(fraOgMed=2022-01-01, tilOgMed=2022-01-01, landkode='SV', landnavn='Sverige', erUtenforEos=false, erBarnetInnlagt=false, erSammenMedBarnet=true, årsak=null)"
        )
    }
}
