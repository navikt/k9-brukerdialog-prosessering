...
import no.nav.brukerdialog.ytelse.pleiepengerilivetssluttfase.api.domene.PILSTestUtils.HALV_ARBEIDSDAG
...
import no.nav.brukerdialog.ytelse.pleiepengerilivetssluttfase.api.domene.PILSTestUtils.enkeltDagerMedJobbSomVanlig
import no.nav.brukerdialog.ytelse.pleiepengerilivetssluttfase.api.domene.PILSTestUtils.enkeltDagerMedRedusertArbeid
import no.nav.brukerdialog.ytelse.pleiepengerilivetssluttfase.api.domene.PILSTestUtils.mandag
import no.nav.brukerdialog.ytelse.pleiepengerilivetssluttfase.api.domene.PILSTestUtils.tirsdag
import no.nav.brukerdialog.ytelse.pleiepengerilivetsslutttfase.api.domene.ArbeidIPeriode
import no.nav.brukerdialog.ytelse.pleiepengerilivetsslutttfase.api.domene.Enkeltdag
