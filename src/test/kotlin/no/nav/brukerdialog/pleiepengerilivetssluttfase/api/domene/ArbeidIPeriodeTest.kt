...
import no.nav.brukerdialog.pleiepengerilivetssluttfase.api.domene.PILSTestUtils.FULL_ARBEIDSDAG
import no.nav.brukerdialog.pleiepengerilivetssluttfase.api.domene.PILSTestUtils.HALV_ARBEIDSDAG
import no.nav.brukerdialog.pleiepengerilivetssluttfase.api.domene.PILSTestUtils.INGEN_ARBEIDSDAG
import no.nav.brukerdialog.pleiepengerilivetssluttfase.api.domene.PILSTestUtils.enkeltDagerMedFulltFravær
import no.nav.brukerdialog.pleiepengerilivetssluttfase.api.domene.PILSTestUtils.enkeltDagerMedJobbSomVanlig
import no.nav.brukerdialog.pleiepengerilivetssluttfase.api.domene.PILSTestUtils.enkeltDagerMedRedusertArbeid
import no.nav.brukerdialog.pleiepengerilivetssluttfase.api.domene.PILSTestUtils.mandag
import no.nav.brukerdialog.pleiepengerilivetssluttfase.api.domene.PILSTestUtils.tirsdag
