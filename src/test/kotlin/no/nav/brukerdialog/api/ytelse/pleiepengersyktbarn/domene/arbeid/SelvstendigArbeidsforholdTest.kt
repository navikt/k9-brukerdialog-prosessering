package no.nav.brukerdialog.api.ytelse.pleiepengersyktbarn.domene.arbeid
...
import no.nav.brukerdialog.api.ytelse.pleiepengersyktbarn.soknad.domene.arbeid.ArbeidsRedusert
import no.nav.brukerdialog.api.ytelse.pleiepengersyktbarn.soknad.domene.arbeid.ArbeidsUke
import no.nav.brukerdialog.api.ytelse.pleiepengersyktbarn.soknad.domene.arbeid.Arbeidsforhold
import no.nav.brukerdialog.api.ytelse.pleiepengersyktbarn.soknad.domene.arbeid.NULL_TIMER
import no.nav.brukerdialog.api.ytelse.pleiepengersyktbarn.soknad.domene.arbeid.NormalArbeidstid
import no.nav.brukerdialog.api.ytelse.pleiepengersyktbarn.soknad.domene.arbeid.RedusertArbeidstidType
...
class SelvstendigArbeidsforholdTest {
        ...
        fun arbeidsforholdMedRedusertSnittPerUke(fraOgMed: LocalDate, tilOgMed: LocalDate) = Arbeidsforhold(
            ...
            arbeidIPeriode = ArbeidIPeriode(
                ...
                redusertArbeid = ArbeidsRedusert(
                    ...
                    arbeidsuker = listOf(
                        ArbeidsUke(
                            periode = no.nav.brukerdialog.api.ytelse.pleiepengersyktbarn.soknad.domene.Periode(
                                fraOgMed = fraOgMed,
                                tilOgMed = tilOgMed
                            ),
    ...
    fun `sn slutter i søknadsperidoen - k9Format validering`() {
        val psbSøknad = no.nav.brukerdialog.api.ytelse.pleiepengersyktbarn.soknad.domene.PleiepengerSyktBarnSøknad(
            fraOgMed = tirsdag,
            tilOgMed = torsdag,
