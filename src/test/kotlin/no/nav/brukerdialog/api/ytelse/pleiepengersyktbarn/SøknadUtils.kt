package no.nav.brukerdialog.api.ytelse.pleiepengersyktbarn
...
import no.nav.brukerdialog.api.ytelse.pleiepengersyktbarn.soknad.domene.Arbeidsgiver
import no.nav.brukerdialog.api.ytelse.pleiepengersyktbarn.soknad.domene.BarnDetaljer
import no.nav.brukerdialog.api.ytelse.pleiepengersyktbarn.soknad.domene.BarnRelasjon
import no.nav.brukerdialog.api.ytelse.pleiepengersyktbarn.soknad.domene.Beredskap
import no.nav.brukerdialog.api.ytelse.pleiepengersyktbarn.soknad.domene.Bosted
...
import no.nav.brukerdialog.api.ytelse.pleiepengersyktbarn.soknad.domene.Medlemskap
import no.nav.brukerdialog.api.ytelse.pleiepengersyktbarn.soknad.domene.Nattevåk
...
import no.nav.brukerdialog.api.ytelse.pleiepengersyktbarn.soknad.domene.OpptjeningIUtlandet
import no.nav.brukerdialog.api.ytelse.pleiepengersyktbarn.soknad.domene.OpptjeningType
import no.nav.brukerdialog.api.ytelse.pleiepengersyktbarn.soknad.domene.Periode
import no.nav.brukerdialog.api.ytelse.pleiepengersyktbarn.soknad.domene.PleiepengerSyktBarnSøknad
import no.nav.brukerdialog.api.ytelse.pleiepengersyktbarn.soknad.domene.SelvstendigNæringsdrivende
import no.nav.brukerdialog.api.ytelse.pleiepengersyktbarn.soknad.domene.Språk
import no.nav.brukerdialog.api.ytelse.pleiepengersyktbarn.soknad.domene.StønadGodtgjørelse
import no.nav.brukerdialog.api.ytelse.pleiepengersyktbarn.soknad.domene.Utenlandsopphold
import no.nav.brukerdialog.api.ytelse.pleiepengersyktbarn.soknad.domene.UtenlandsoppholdIPerioden
import no.nav.brukerdialog.api.ytelse.pleiepengersyktbarn.soknad.domene.arbeid.ArbeidIPeriode
import no.nav.brukerdialog.api.ytelse.pleiepengersyktbarn.soknad.domene.arbeid.ArbeidIPeriodeType
import no.nav.brukerdialog.api.ytelse.pleiepengersyktbarn.soknad.domene.arbeid.Arbeidsforhold
import no.nav.brukerdialog.api.ytelse.pleiepengersyktbarn.soknad.domene.arbeid.NormalArbeidstid
import no.nav.brukerdialog.api.ytelse.pleiepengersyktbarn.soknad.domene.Årsak
