...
class PleiepengerSyktBarnController(
    ...
    private companion object {
        private val logger: Logger = LoggerFactory.getLogger(no.nav.brukerdialog.ytelse.pleiepengersyktbarn.api.PleiepengerSyktBarnController::class.java)
    }
    ...
    fun innsending(
        ...
        no.nav.brukerdialog.ytelse.pleiepengersyktbarn.api.PleiepengerSyktBarnController.Companion.logger.info(formaterStatuslogging(søknad.ytelse(), søknad.søknadId, "mottatt."))
