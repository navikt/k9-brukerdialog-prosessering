...
class AktivitetspengerInntektsrapporteringPdfData(private val søknad: AktivitetspengerInntektsrapporteringMottatt) :
    PdfData() {
    ...
    override fun pdfData(): Map<String, Any?> {
        ...
        return mapOf(
            ...
            "inntektForPeriode" to k9Format.getYtelse<Aktivitetspenger>().inntekter?.somMap(),
