...
data class AktivitetspengerOppgavebekreftelseInnsending(
    val komplettOppgavebekreftelse: KomplettAktivitetspengerOppgaveDTO,
    val mottatt: ZonedDateTime = ZonedDateTime.now(ZoneOffset.UTC),
) : Innsending {
    companion object {
        private val AKTIVITETSPENGER_OPPGAVE_VERSJON = Versjon.of("1.0.0")
    }
    ...
    override fun somKomplettSøknad(
        ...
        return AktivitetspengerKomplettOppgavebekreftelse(
    ...
    override fun somK9Format(søker: Søker, metadata: MetaInfo): OppgaveBekreftelse {
        return OppgaveBekreftelse()
            .medVersjon(AKTIVITETSPENGER_OPPGAVE_VERSJON)
...
data class AktivitetspengerKomplettOppgavebekreftelse(
    val søknadId: String,
