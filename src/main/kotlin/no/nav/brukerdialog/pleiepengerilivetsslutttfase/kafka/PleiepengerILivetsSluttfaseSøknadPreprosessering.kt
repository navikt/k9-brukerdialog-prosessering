package no.nav.brukerdialog.pleiepengerilivetsslutttfase.kafka
...
import no.nav.brukerdialog.pleiepengerilivetsslutttfase.kafka.PILSTopologyConfiguration.Companion.PILS_PREPROSESSERING_STREAMS_BUILDER_NAME
