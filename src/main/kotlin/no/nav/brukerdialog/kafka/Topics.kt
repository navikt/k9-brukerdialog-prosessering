...
import no.nav.brukerdialog.api.ytelse.Ytelse.DINE_PLEIEPENGER
import no.nav.brukerdialog.api.ytelse.Ytelse.ENDRINGSMELDING_PLEIEPENGER_SYKT_BARN
import no.nav.brukerdialog.api.ytelse.Ytelse.ETTERSENDING
import no.nav.brukerdialog.api.ytelse.Ytelse.ETTERSENDING_OMP
import no.nav.brukerdialog.api.ytelse.Ytelse.ETTERSENDING_PLEIEPENGER_LIVETS_SLUTTFASE
import no.nav.brukerdialog.api.ytelse.Ytelse.ETTERSENDING_PLEIEPENGER_SYKT_BARN
import no.nav.brukerdialog.api.ytelse.Ytelse.OMSORGSDAGER_ALENEOMSORG
import no.nav.brukerdialog.api.ytelse.Ytelse.OMSORGSPENGER_MIDLERTIDIG_ALENE
import no.nav.brukerdialog.api.ytelse.Ytelse.OMSORGSPENGER_UTBETALING_ARBEIDSTAKER
import no.nav.brukerdialog.api.ytelse.Ytelse.OMSORGSPENGER_UTBETALING_SNF
import no.nav.brukerdialog.api.ytelse.Ytelse.OMSORGSPENGER_UTVIDET_RETT
import no.nav.brukerdialog.api.ytelse.Ytelse.PLEIEPENGER_LIVETS_SLUTTFASE
import no.nav.brukerdialog.api.ytelse.Ytelse.PLEIEPENGER_SYKT_BARN
