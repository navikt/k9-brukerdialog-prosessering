package no.nav.brukerdialog.meldinger.endringsmelding

import no.nav.brukerdialog.meldinger.endringsmelding.PSBEndringsmeldingTopologyConfiguration.Companion.PSB_ENDRINGSMELDING_PREPROSESSERING_STREAMS_BUILDER_NAME
