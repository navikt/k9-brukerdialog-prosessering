...
import no.nav.k9brukerdialogprosessering.api.ytelse.Ytelse.DINE_PLEIEPENGER
import no.nav.k9brukerdialogprosessering.api.ytelse.Ytelse.ENDRINGSMELDING_PLEIEPENGER_SYKT_BARN
import no.nav.k9brukerdialogprosessering.api.ytelse.Ytelse.ETTERSENDING
import no.nav.k9brukerdialogprosessering.api.ytelse.Ytelse.ETTERSENDING_OMP
import no.nav.k9brukerdialogprosessering.api.ytelse.Ytelse.ETTERSENDING_PLEIEPENGER_LIVETS_SLUTTFASE
import no.nav.k9brukerdialogprosessering.api.ytelse.Ytelse.ETTERSENDING_PLEIEPENGER_SYKT_BARN
import no.nav.k9brukerdialogprosessering.api.ytelse.Ytelse.OMSORGSDAGER_ALENEOMSORG
import no.nav.k9brukerdialogprosessering.api.ytelse.Ytelse.OMSORGSPENGER_MIDLERTIDIG_ALENE
import no.nav.k9brukerdialogprosessering.api.ytelse.Ytelse.OMSORGSPENGER_UTBETALING_ARBEIDSTAKER
import no.nav.k9brukerdialogprosessering.api.ytelse.Ytelse.OMSORGSPENGER_UTBETALING_SNF
